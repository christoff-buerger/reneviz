...
public class TargetPropertyFacet extends Facet {

	public TargetPropertyFacet(String name, Resource topic, Property property,
			double weight) {
		super(name, topic, property, weight);
		// TODO add direction?
	}

	public TargetPropertyFacet(String name, Resource topic,
